...
class ModelShowPost extends BaseModel {
    ...
    public function get_data() {
        ...
        if($_SERVER['REQUEST_METHOD'] != 'POST') {
            ...
            if(is_null($userData['errors']) && $userData['isConfirm'] == 0) return array_merge(['errors' => ['Для того что бы оставлять комментарии необходимо подтвердить аккаунт']], $dataPost, $userData, ['comments' => $listComments]);
