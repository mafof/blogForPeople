    ...
    <form action="/createpost" method="post" enctype="multipart/form-data" class="card card-register" id="form-register">
        <div class="row">
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" placeholder="Заголовок" maxlength="50" required>
            ...
            <div class="form-group">
                ...
                <textarea type="text" name="prev-text" id="prev-text" placeholder="Превью текста" maxlength="255" required></textarea>
                <small class="error-code"></small>
            </div>
            <div class="form-group">
                ...
                <textarea type="text" name="text" id="text" placeholder="Полный текст" required></textarea>
            </div>
